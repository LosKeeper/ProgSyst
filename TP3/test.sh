...
EOF
    ...
    rm -f STA_1 STA_2
    ./trame 1 2 aaaa ; ./trame 2 1 bbbb ; ./trame 1 2 cccc ; ./trame 2 1 dddd
    cat > $TMP/sortie <<EOF
1 - 2 - 1 - bbbb
1 - 2 - 1 - dddd
2 - 1 - 2 - aaaa
...
test_3()
{
    ...
    ./trame 1 2 aaaa ; ./trame 1 3 bbbb ; ./trame 2 1 cccc
    ./trame 2 3 dddd ; ./trame 3 1 eeee ; ./trame 3 2 ffff
    cat > $TMP/sortie <<EOF
1 - 2 - 1 - cccc
1 - 3 - 1 - eeee
2 - 1 - 2 - aaaa
